...
class Player():
    def __init__(self, name, amount_dice):
        self.name = name
...
class Perudo():
    def __init__(self, dice, players, dark=True):
        self.dark = dark
        self.game_over = False
        
        self.amount_dice = dice
        self.amount_players = len(players)
        self.players = [Player(name, dice) for name in players]
